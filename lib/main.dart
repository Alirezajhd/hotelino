...
import 'package:Hotelino/features/home/presentation/profileProvider.dart';
...
void main() async {
  ...
  final hotelRepository = HotelRepositories(
  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(
          create: (_) => Profileprovider(hotelRepository, ProfileRepository()),
        ),
        ChangeNotifierProvider(
